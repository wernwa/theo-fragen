...
\item Die ebenen Wellen $\psi(\vec{r},t)=c\cdot
  e^{\frac{i}{\hbar}(\vec{p}\cdot\vec{r}-\frac{p^{2}}{2m}t)}$ sollen
  Lösungen der Gleichung sein. \\
  ...
  &= \frac{i\hbar}{2m}\cdot
  \underbrace{\frac{(ip)^2}{\hbar^2}\psi(\vec{r},t)}_{\nabla^2\psi(\vec{r},t)}\\
  &= \frac{i\hbar}{2m}\nabla^2\psi(\vec{r},t)
\end{align*}
\end{enumerate}
