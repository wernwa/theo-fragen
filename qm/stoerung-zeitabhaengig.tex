...
Die Rechnung für den Erwartungswert \(\langle \sin^2(\vec k\cdot \vec x - \omega t)=\frac{1}{2}\) findet sich ausführlich in dem PDF \url{http://github.com/wernwa/theo-fragen/raw/master/qm/sin^2-erwartungswert.pdf}.\\
\\
