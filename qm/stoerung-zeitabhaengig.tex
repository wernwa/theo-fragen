...
Wir drücken die Energiedichte nur durch das \(E\)-Feld aus mit der Ausnutzung, dass das Energiefeld des Elektrischen Feldes und des Magnetischen Feldes im Strahlungsfeld wegen der Energieerhaltung gleich groß ist. Ersetze \(\vec B^2 = \frac{1}{c}\vec E^2\)

\begin{align}
  \label{eq:69}
  \text{Energiedichte} = \vec \nabla\cdot H = \frac{1}{2}\left(\epsilon_0 \vec E^2 + \frac{1}{c\mu_0} \vec E^2  \right) = \epsilon_0 \vec E^2
\end{align}
