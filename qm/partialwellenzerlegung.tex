...
Mit der Relation \((e^{2i\delta_l}-1)/2i = (e^{2i\delta_l}-e^{i\delta_l}e^{-i\delta_l})/2i =e^{i\delta_l} (e^{i\delta_l}-e^{-i\delta_l})/2i= e^{i\delta_l}\sin\delta_l\) erhalten wir für die Streuamplitude als Endergebnis
